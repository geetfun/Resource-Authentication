...
require File.dirname(__FILE__) + "/resource_authentication/controller_adapters/merb_adapter" if defined?(Merb)
...
require File.dirname(__FILE__) + "/resource_authentication/session/activation"
require File.dirname(__FILE__) + "/resource_authentication/session/base"
