...
# module AuthlogicActiveResource
...
#       klass.class_eval do
#         extend Config
#         add_resource_authentic_module(Methods)
#       end
#     end
#     
...
#       def self.included(klass)
#         klass.class_eval do
#           if validate_email_field && email_field && !@run_already
#             @run_already ||= true # Hack to ensure this is only run once during tests
