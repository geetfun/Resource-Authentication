...
module ResourceAuthentication
  ...
  module TestCase
    ...
    def activate_authlogic
      ResourceAuthentication::Session::Base.controller = (@request && ResourceAuthentication::TestCase::RailsRequestAdapter.new(@request)) || controller
    end
    
    # The Authlogic::TestCase::MockController object passed to Authlogic to activate it. You can access this in your test.
    # See the module description for an example.
    def controller
      @controller ||= ResourceAuthentication::TestCase::MockController.new
    end
  end
