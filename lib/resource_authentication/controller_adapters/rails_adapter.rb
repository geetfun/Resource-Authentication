      ...
      module RailsImplementation
        ...
        private
          def activate_authlogic
            ResourceAuthentication::Session::Base.controller = RailsAdapter.new(self)
          end
      end
    end
  end
...
ActionController::Base.send(:include, ResourceAuthentication::ControllerAdapters::RailsAdapter::RailsImplementation)